...
de trabajo corresponden a cada producto mínimamente viable (\textit{PMV}) y, asu vez, en diferentes capas de abstracción del producto.
...
Las historias de usuario se encuentran disgregando los aspéctos atómicos del \textit{user journey} que aportan valor.
Deben de definirse en el dominio del problema, por lo que están relacionadas con la lógica de negocio.
Las historias de usuario describen la necesidad del usuario abtrayendose de los detalles técnicos, ya que
