...
El triage tiene un gran potencial que no se aprovecha en los sistemas de citas de la sanidad actual, durante todo el desarollo 
el sistema se comparará con el sistema de citas \href{https://www.sspa.juntadeandalucia.es/servicioandaluzdesalud/clicsalud/pages/portada.jsf?caducada=1}{ClicSalud+},
 al igual que los tiempos medios de espera de los pacientes para afirmar que el desarollo del sistema implica una mejora real.

\subsection{Proyecto a futuro}
El principal proyecto a futuro sería extraer la utilidad del triage inteligente convirtiendo el sistema en una librería de código 
que se pueda acoplar al sistema de citas del cliente que lo solicite, aunque conlleve mucho trabajo.
Además, podrían desarrollarse los siguientes puntos:

\begin{itemize}
    \item Un paciente necesita tener prioridad para consultas especializadas (Neurología, Urología, Ginecología\dots) 
    \item Un paciente necesita acceder a las recetas de los medicamentos de una consulta.
    \item Un paciente necesita consultas periódicas por una enfermedade crónicas.
