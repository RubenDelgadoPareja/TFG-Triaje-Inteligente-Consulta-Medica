...
El sistema de triage conlleva crear un sistema de colas de citas priorizadas, las cuales se ordenarán mediante una heurística que tendrá 
...
\begin{itemize}
    ...
    \item Modificar el riesgo de los usuarios
