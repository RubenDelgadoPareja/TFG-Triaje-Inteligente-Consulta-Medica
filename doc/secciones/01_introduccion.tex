...
La asignación de riesgo se realizará mediante un formulario que deben rellenar el paciente al registrarse, esta prioridad
se comprobará y podrá ser modificado por los sanitarios. Esto es necesario, ya que, la mayoría de pacientes aumentarán de riesgo 
con los años y con las enfermedades que padezcan. 
...
el sistema se comparará con el sistema de citas \href{https://www.sspa.juntadeandalucia.es/servicioandaluzdesalud/clicsalud/pages/portada.jsf?caducada=1}{ClicSalud+},
 al igual que los tiempos medios de espera de los pacientes para afirmar que el desarrollo del sistema implica una mejora. 
