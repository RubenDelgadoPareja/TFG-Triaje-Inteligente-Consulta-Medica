...
La implementación del software se ha dividido en hitos \ref*{sec:hitos}. Cada hito representa un PMV que se publicará.
...
En la documentación se ha plasmado la planificación inicial del proyecto y configuraciones de herramientas.
