...
class Paciente < ApplicationRecord
  ...
  validates :numero_seguridad_social, presence: true, uniqueness: true
  validates :nombre, presence: true
  validates :apellidos, presence: true
  validates :lugar_cita, presence: true
  validates :riesgo, presence: true
  validates :historial_clinico, presence: true
  ...
  def cambiar_medico(nuevo_medico)
    self.medico = nuevo_medico
    save
  end

  def cambiar_consultorio(nuevo_consultorio)
    self.lugar_cita = nuevo_consultorio
    save
  end
end  
\end{lstlisting}
